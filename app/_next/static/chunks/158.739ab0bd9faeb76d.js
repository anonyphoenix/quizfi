"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[158],{83158:function(e,t,i){i.r(t),i.d(t,{W3mModal:function(){return c}});var o=i(85014),n=i(70169),s=i(12937),a=i(15376),r=s.iv`
  :host {
...
`,l=function(e,t,i,o){var n,s=arguments.length,a=s<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,i,o);else for(var r=e.length-1;r>=0;r--)(n=e[r])&&(a=(s<3?n(a):s>3?n(t,i,a):n(t,i))||a);return s>3&&a&&Object.defineProperty(t,i,a),a};let d="scroll-lock",c=class extends s.oi{constructor(){super(),this.unsubscribe=[],this.abortController=void 0,this.open=o.IN.state.open,this.caipAddress=o.Ni.state.caipAddress,this.isSiweEnabled=o.hD.state.isSiweEnabled,this.connected=o.Ni.state.isConnected,this.loading=o.IN.state.loading,this.initializeTheming(),o.QT.prefetch(),this.unsubscribe.push(o.IN.subscribeKey("open",e=>e?this.onOpen():this.onClose()),o.IN.subscribeKey("loading",e=>{this.loading=e,this.onNewAddress(o.Ni.state.caipAddress)}),o.Ni.subscribeKey("isConnected",e=>this.connected=e),o.Ni.subscribeKey("caipAddress",e=>this.onNewAddress(e)),o.hD.subscribeKey("isSiweEnabled",e=>this.isSiweEnabled=e)),o.Xs.sendEvent({type:"track",event:"MODAL_LOADED"})}disconnectedCallback(){this.unsubscribe.forEach(e=>e()),this.onRemoveKeyboardListener()}render(){return this.open?s.dy`
        ...
        `:null}async onOverlayClick(e){e.target===e.currentTarget&&await this.handleClose()}async handleClose(){if(this.isSiweEnabled){let{SIWEController:e}=await Promise.all([i.e(165),i.e(287)]).then(i.bind(i,30451));"success"!==e.state.status&&this.connected&&await o.lZ.disconnect()}o.IN.close()}initializeTheming(){let{themeVariables:e,themeMode:t}=o.u0.state,i=n.UiHelperUtil.getColorTheme(t);(0,n.initializeTheming)(e,i)}onClose(){this.open=!1,this.classList.remove("open"),this.onScrollUnlock(),o.KC.hide(),this.onRemoveKeyboardListener()}onOpen(){this.open=!0,this.classList.add("open"),this.onScrollLock(),this.onAddKeyboardListener()}onScrollLock(){let e=document.createElement("style");e.dataset.w3m=d,e.textContent=`
      body {
        touch-action: none;
        overflow: hidden;
